...
const MAGIC_LINK_TEMPLATE_MAP = {
  [PRODUCTS.ADMIN]: process.env.ADMIN_MAGIC_LINK_TEMPLATE_ALIAS
    ? process.env.ADMIN_MAGIC_LINK_TEMPLATE_ALIAS
    : MAGIC_LINK_TEMPLATES.ADMIN,
  [PRODUCTS.DASHBOARD]: process.env.DASHBOARD_MAGIC_LINK_TEMPLATE_ALIAS
    ? process.env.DASHBOARD_MAGIC_LINK_TEMPLATE_ALIAS
    : MAGIC_LINK_TEMPLATES.DASHBOARD,
}
